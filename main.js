...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.todayCont{
...
}`, "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;IACI,sBAAsB;AAC1B,aAAa;AACb,uBAAuB;AACvB,mBAAmB;AACnB,SAAS;AACT,aAAa;AACb,2BAA2B;AAC3B;AACA;IACI,aAAa;IACb,6BAA6B;IAC7B,sBAAsB;IACtB,QAAQ;IACR,sBAAsB;IACtB,eAAe;IACf,iBAAiB;AACrB;AACA;IACI,aAAa;IACb,6BAA6B;IAC7B,kBAAkB;IAClB,QAAQ;IACR,sBAAsB;IACtB,MAAM;IACN,eAAe;AACnB;;AAEA;IACI,aAAa;IACb,8BAA8B;IAC9B,QAAQ;IACR,iBAAiB;IACjB,kBAAkB;;;AAGtB;AACA;IACI,cAAc;IACd,eAAe;AACnB;AACA;IACI,kBAAkB;AACtB;AACA;IACI,cAAc;AAClB;;AAEA;IACI,aAAa;IACb,YAAY;AAChB;AACA;IACI,cAAc;AAClB;AACA;IACI,aAAa;IACb,sBAAsB;IACtB,kBAAkB;IAClB,SAAS;;AAEb;AACA;IACI,aAAa;IACb,sBAAsB;IACtB,kBAAkB;IAClB,sBAAsB;;;AAG1B","sourcesContent":[".todayCont{\n    background-color: aqua;\ndisplay: flex;\njustify-content: center;\nalign-items: center;\ngap:150px;\npadding: 25px;\nflex-direction: row-reverse;\n}\n.todayLeft{\n    display: flex;\n    justify-content: space-around;\n    align-items:flex-start;\n    gap:30px;\n    flex-direction: column;\n    font-size: 18px;\n    padding-top: 50px;\n}\n.todayRight{\n    display: flex;\n    justify-content: space-around;\n    align-items:center;\n    gap:15px;\n    flex-direction: column;\n    width:;\n    font-size: 20px;\n}\n\n.container{\n    display: grid;\n    grid-template-columns: 1fr 1fr;\n    gap:20px;\n    padding-top: 15px;\n    padding-left: 15px;\n    \n    \n}\n.day{\n    font-size:25px;\n    font-weight:900;\n}\n.day2, .day4{\n    padding-left: 25px;\n}\n.text{\n    font-size:20px;\n}\n\n.icon{\n    height: 150px;\n    width: 150px;\n}\n.temp{\n    font-size:45px;\n}\n.search{\n    display: flex;\n    justify-content:center;\n    align-items:center;\n    gap: 15px;\n    \n}\n.next{\n    display: flex;\n    justify-content:center;\n    align-items:center;\n    flex-direction: column;\n   \n\n}"],"sourceRoot":""}]);
// Exports
