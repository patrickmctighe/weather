...
.search1{
    font-size: 25px;
}`, "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;IACI,2BAA2B;IAC3B;AACJ;AACA;IACI,kBAAkB;IAClB,UAAU;AACd;AACA;;AAEA,aAAa;AACb,uBAAuB;AACvB,mBAAmB;AACnB,SAAS;AACT,aAAa;AACb,2BAA2B;AAC3B;AACA;IACI,aAAa;IACb,6BAA6B;IAC7B,sBAAsB;IACtB,QAAQ;IACR,sBAAsB;IACtB,eAAe;IACf,iBAAiB;AACrB;AACA;IACI,aAAa;IACb,6BAA6B;IAC7B,kBAAkB;IAClB,QAAQ;IACR,sBAAsB;IACtB,MAAM;IACN,eAAe;AACnB;;AAEA;IACI,aAAa;IACb,8BAA8B;IAC9B,QAAQ;IACR,iBAAiB;IACjB,kBAAkB;IAClB,uBAAuB;IACvB,mBAAmB;;;AAGvB;AACA;IACI,cAAc;IACd,eAAe;AACnB;AACA;IACI,kBAAkB;AACtB;AACA;AACA,aAAa;IACT,uBAAuB;IACvB,mBAAmB;IACnB,sBAAsB;AAC1B;AACA;IACI,cAAc;AAClB;;AAEA;IACI,aAAa;IACb,YAAY;AAChB;AACA;IACI,cAAc;AAClB;AACA;IACI,aAAa;IACb,sBAAsB;IACtB,kBAAkB;IAClB,SAAS;IACT,iBAAiB;AACrB;AACA;IACI,aAAa;IACb,sBAAsB;IACtB,kBAAkB;IAClB,sBAAsB;;;AAG1B;;AAEA;IACI,eAAe;AACnB","sourcesContent":["*{\n    background-color: lightblue;\n    color:\n}\n.head{\n    position: relative;\n    left:150px;\n}\n.todayCont{\n   \ndisplay: flex;\njustify-content: center;\nalign-items: center;\ngap:150px;\npadding: 25px;\nflex-direction: row-reverse;\n}\n.todayLeft{\n    display: flex;\n    justify-content: space-around;\n    align-items:flex-start;\n    gap:30px;\n    flex-direction: column;\n    font-size: 18px;\n    padding-top: 50px;\n}\n.todayRight{\n    display: flex;\n    justify-content: space-around;\n    align-items:center;\n    gap:15px;\n    flex-direction: column;\n    width:;\n    font-size: 20px;\n}\n\n.container{\n    display: grid;\n    grid-template-columns: 1fr 1fr;\n    gap:30px;\n    padding-top: 15px;\n    padding-left: 15px;\n    justify-content: center;\n    align-items: center;\n    \n    \n}\n.day{\n    font-size:25px;\n    font-weight:900;\n}\n.day2, .day4{\n    padding-left: 25px;\n}\n.day1, .day2, .day3, .day4{\ndisplay: flex;\n    justify-content: center;\n    align-items: center;\n    flex-direction: column;\n}\n.text{\n    font-size:20px;\n}\n\n.icon{\n    height: 150px;\n    width: 150px;\n}\n.temp{\n    font-size:45px;\n}\n.search{\n    display: flex;\n    justify-content:center;\n    align-items:center;\n    gap: 15px;\n    padding-top: 35px;\n}\n.next{\n    display: flex;\n    justify-content:center;\n    align-items:center;\n    flex-direction: column;\n   \n\n}\n\n.search1{\n    font-size: 25px;\n}"],"sourceRoot":""}]);
// Exports
...
/* harmony export */   keyCurrent: () => (/* binding */ keyCurrent),
/* harmony export */   keyForecast: () => (/* binding */ keyForecast)
/* harmony export */ });
...
.then(function(response){
    ...
    day.innerHTML = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(), "eeee");
    // text
...
function getForecast() {
    ...
    .then(function(response){
        for(let i = 1 ; i < 5 ; i++){ 
            ...
            dayName.innerHTML = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(response.forecast.forecastday[i+1].date), "eeee");
...
function search(){searchButton.addEventListener('click', function(event) {
    event.preventDefault();
   container.innerText="";
   todayCont.innerText="";
  const keyword = searchInput.value;
  searchInput.value="";
(0,_api__WEBPACK_IMPORTED_MODULE_0__.keyCurrent)(keyword);
(0,_api__WEBPACK_IMPORTED_MODULE_0__.keyForecast)(keyword);
});}
...
(0,_api__WEBPACK_IMPORTED_MODULE_0__.getCurrent)()
;(0,_api__WEBPACK_IMPORTED_MODULE_0__.getForecast)()
;(0,_functions__WEBPACK_IMPORTED_MODULE_2__.search)()
